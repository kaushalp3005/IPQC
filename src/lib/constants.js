...
export const PHYSICAL_DATES_PARAMS = [
...
export const PHYSICAL_SEEDS_PARAMS = [
  { key: "count", label: "Count" },
  { key: "infestation", label: "Infestation" },
  { key: "foreign_matter", label: "Foreign Matter" },
  { key: "discolor", label: "Discolor" },
...
export const PHYSICAL_ALL_PARAMS = [
...
export const LABEL_CHECK_PARAMS = [
...
export function getPhysicalParams(category) {
